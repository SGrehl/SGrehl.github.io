...
5.  Remember Boudon's [-@boudon1977] model of relative deprivation? It considers only three factors: the costs $c$ of applying for a promotion, the benefits $b$ of receiving the promotion, and the relative share of available positions $f$, all of which are assumed to be common knowledge.
    ...
    2.  \[hard\] ~~Try to derive the general function of p for any~~ $n$ ~~and~~ $f$~~.~~ [Just realized that the original model I presented is not correct, and that this is nearly impossible to do for you! Sorry.]{style="background-color: yellow;"}

    3.  \[still hard enough\] Try to get all possible Nash equilibria for the Model 5.1. (Tip: There are two cases with different numbers of equilibria).
...
::: callout-warning
Here is the [link for the in-class material](week02_inclass.html).
:::
