...
::: fragment
![Proposed effect of benefits, costs, and positions on success probability.](images/clipboard-517026373.png){#fig-tocqueville-dag fig-align="center" width="500"}
:::
...
<input type="range" id="delay" min="0" max="3000" value="100">
:::
...
(This example is based on @schelling1978, and builds extensively on the earlier work of [Frank McCown](http://nifty.stanford.edu/2014/mccown-schelling-model-segregation/))
:::
:::::
...
-   **Objective:**
    Simulate the diffusion trajectory of innovations.
-   **Methodology:**
    -   Adjusted model parameters until simulated diffusion matched observed patterns.

![](images/clipboard-2258837400.png){#fig-heage fig-alt="Idealizatoin of a province in Sweden" fig-align="center"}
...
![](images/clipboard-2984186190.png)

### Types of Realism - Example

![](images/clipboard-2731342530.png)
...
Instead of multiplying two numbers directly, this approach randomly "throws darts" at the canvas and counts how many land inside the rectangle to estimate its area. It’s a textbook example of using a powerful technique where it's absolutely not needed — a beautifully inefficient solution to a trivial problem.
