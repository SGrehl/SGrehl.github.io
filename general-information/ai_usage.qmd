...
![The Chemetall Foot Lithium Operation in Clayton Valley, Nevada (Image by PDTillman, Wikipedia Commons)](Graphics/lithium%20mine.jpg){width="350"}
...
If you know and use further cool AI-Applications, feel free to share them with us (and we will add them to the list)!

+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| **Tool**              | **Function**                         | **Version**               | **Usage**                                   |
+=======================+======================================+===========================+=============================================+
| ChatGPT               |                                      |                           | -   Coding                                  |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Writing                                 |
...
| Canvas                |                                      |                           |                                             |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Elicit                | Exploring research papers            |                           | -   Literature review                       |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Notion                | All-in-one workspace                 | Free Version for students | -   Organizing                              |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Writing                                 |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   **Leos favorite**                       |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| GitHub Copilot        | Coding Assistant                     | Free Version for Students | -   Code Completion                         |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Debugging                               |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Gemini                | Google\`s AI Chatbot                 |                           | -   Writing                                 |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Research                                |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Coding                                  |
...
|                       |                                      |                           | -   Image Generation                        |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| ChatAI                | Locally hosted **DSGVO-conform** LLM | Free for Students         |                                             |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Scite.ai              | Exploring research papers            |                           | -   Research                                |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Citation Analysis                       |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Connected Papers      | Research Paper Visualisation         | Free                      | -   Finding related papers                  |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Literature review                       |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| Obsidian.md           | Knowledge management markdwon tool   | Free & Paid               | -   Note taking                             |
|                       |                                      |                           |                                             |
|                       |                                      |                           | -   Organization                            |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+
| theresanaiforthat.com | Repository of AI apps                | Free                      | Search for AI tools based on specific needs |
+-----------------------+--------------------------------------+---------------------------+---------------------------------------------+

: AI-Tools for academic research {.hover .striped}
