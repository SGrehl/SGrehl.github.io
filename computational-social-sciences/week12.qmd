...
Weights are usually **row-standardized** (so each row sums to 1). Row standardization is used to create proportional weights in cases where features have an unequal number of neighbors.
...
1. Compute the Global Morans I for child poverty: `x2016_child_poverty`
