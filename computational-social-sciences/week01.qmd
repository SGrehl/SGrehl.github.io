...
R is modular through the use of opackages, and it keeps on expanding

Can be used for all steps in the research process (data collection, processing, exploration, analysis and reporting/ publishing)

Keeps groing with cool community groups

R-Ladies, R Consortium, rOpenSci, etc.
